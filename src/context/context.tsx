    ...
    const [products, setProducts] = useState<products>(() => {
        ...
        return storedProducts ? JSON.parse(storedProducts) : {
            mostPopular: [
                ...
                {url: "/src/images/products/most-popular/tomatoes.jpg", name: 'Tomatoes', mass: '1kg', price: 99, amount: 0},
                {url: "/src/images/products/most-popular/sour-cream.jpg", name: 'Sour cream', mass: '280g', price: 175, amount: 0},
                {url: "/src/images/products/most-popular/mozzarella.jpg", name: 'Mozzarella', mass: '400g', price: 500, amount: 0},
                {url: "/src/images/products/most-popular/bread.jpg", name: 'Bread', mass: '120g', price: 69, amount: 0},
                {url: "/src/images/products/most-popular/eggs.jpg", name: 'Eggs C1', mass: '10 pcs', price: 2000, amount: 0},
                {url: "/src/images/products/most-popular/morse.jpg", name: 'Morse (strawberry)', mass: '980ml', price: 100, amount: 0},
                {url: "/src/images/products/most-popular/honey.jpg", name: 'Honey', mass: '4l', price: 249, amount: 0},
            ],
            farmProducts: [
            ...
            drinks: [
                ...
                {url: "/src/images/products/good3.jpg", name: 'Item 21', mass: '500g', price: 2, amount: 0},
                {url: "/src/images/products/good3.jpg", name: 'Item 22', mass: '500g', price: 2000, amount: 0},
                {url: "/src/images/products/good3.jpg", name: 'Item 23', mass: '500g', price: 200, amount: 0},
                {url: "/src/images/products/good3.jpg", name: 'Item 24', mass: '500g', price: 200, amount: 0},
            ],
            forHome: [
                {url: "/src/images/products/good3.jpg", name: 'Item 25', mass: '500g', price: 2, amount: 0},
                {url: "/src/images/products/good3.jpg", name: 'Item 26', mass: '500g', price: 2000, amount: 0},
                {url: "/src/images/products/good3.jpg", name: 'Item 27', mass: '500g', price: 200, amount: 0},
                {url: "/src/images/products/good3.jpg", name: 'Item 28', mass: '500g', price: 200, amount: 0},
                {url: "/src/images/products/good3.jpg", name: 'Item 29', mass: '500g', price: 2, amount: 0},
                {url: "/src/images/products/good3.jpg", name: 'Item 30', mass: '500g', price: 2000, amount: 0},
                {url: "/src/images/products/good3.jpg", name: 'Item 31', mass: '500g', price: 200, amount: 0},
                {url: "/src/images/products/good3.jpg", name: 'Item 32', mass: '500g', price: 200, amount: 0},
            ]
        }
    });
